...
const sampleTasks = [
  ...
  },
  {
    ...
    priority: 'critical',
    description:
      'Perform schema migration to add priorityScore and index on assignee. Requires maintenance window.',
    assignee: 'Dana Patel',
  ...
  },
  {
    ...
    priority: 'low',
    description:
      'Adjust padding so page content does not sit under the fixed navbar on small screens.',
